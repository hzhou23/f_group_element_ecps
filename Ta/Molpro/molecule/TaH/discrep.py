...
ecps = ['UC', 'crenbl', 'lanl2', 'mdfstu','sbkjc','mwbstu','ECP28','ECP29','ECP23','ECP30']#, 'w3', 'w6', 'w9']#,'i0','i7', 'i6']#'sub0','smal-se3','se3','se4']
styles={
...
'ECP28'	        :{'label':'ECP28',	'color':'#009900','linestyle':'--','dashes':(8,1,1,1,1,1)},
'ECP29'          :{'label':'ECP29',   'color':'#8A3324','linestyle':'--','dashes':(8,1,1,1,1,1)},
'ECP23'          :{'label':'ECP23',   'color':'#E3CF57','linestyle':'--','dashes':(8,1,1,1,1,1)},
'ECP30'          :{'label':'ECP30',   'color':'#FF6103','linestyle':'--','dashes':(8,1,1,1,1,1)},
}
...
def plot():
    ...
    data = get_data()
    #print data.head()
    data.to_csv("TaH_TZ.csv", sep=',', index=False)
...
#    ax.set_ylim((-0.25,0.25))
    ax.set(title='TaH tz Discrepancies')
    #plt.legend(bbox_to_anchor=(0.53, 0.15, 0.5, 0.5), fontsize="x-small")
    plt.legend(loc='best',ncol=2,prop={'size': 15})
    plt.axvline(1.7836952306914098,ls='--',color='gray',linewidth=1.0)
    plt.savefig('TaH_TZ.pdf')
    plt.show()
