...
ecps = ['UC', 'crenbl', 'lanl2', 'mdfstu','sbkjc','mwbstu','ECP1','ECP2','ECP3','ECP14']#, 'w3', 'w6', 'w9']#,'i0','i7', 'i6']#'sub0','smal-se3','se3','se4']
styles={
...
'ECP14'          :{'label':'ECP14',   'color':'#FF7F00','linestyle':'--','dashes':(8,1,1,1,1,1)},
}
