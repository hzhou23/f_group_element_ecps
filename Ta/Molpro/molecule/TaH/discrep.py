...
ecps = ['UC', 'crenbl', 'lanl2', 'mdfstu','sbkjc','mwbstu','ECP39','ECP40','ECP2','ECP14','ECP41','ECP42']#, 'w3', 'w6', 'w9']#,'i0','i7', 'i6']#'sub0','smal-se3','se3','se4']
styles={
...
'ECP38'          :{'label':'ECP38',   'color':'#BF3EFF','linestyle':'--','dashes':(8,1,1,1,1,1)},
}
