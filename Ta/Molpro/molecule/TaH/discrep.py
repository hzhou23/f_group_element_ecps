...
ecps = ['UC', 'crenbl', 'lanl2', 'mdfstu','sbkjc','mwbstu','ECP1','ECP2','ECP3','ECP11']#, 'w3', 'w6', 'w9']#,'i0','i7', 'i6']#'sub0','smal-se3','se3','se4']
styles={
...
'ECP11'          :{'label':'ECP11',   'color':'#CDAA7D','linestyle':'--','dashes':(8,1,1,1,1,1)},
}
