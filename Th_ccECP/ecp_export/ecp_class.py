...
my_ecp.write_molpro('Tb.ccECP.molpro')
my_ecp.write_nwchem('Tb.ccECP.nwchem')
my_ecp.write_gamess('Tb.ccECP.gamess')
my_ecp.write_dirac('Tb.ccECP.dirac')
my_ecp.write_qwalk_so('Tb.ccECP.qwalk')
my_ecp.write_manuscript('Tb.ccECP.man')
