...
ae_file_names = ["ae1.d","ae2.d","ae3.d","ae4.d","ae5.d","ae6.d","ae7.d","ae8.d","ae9.d","ae10.d","ae11.d","ae12.d","ae13.d","ae14.d","ae15.d"]
Lu.write_yoon(result_path = result_path_ae, file_names = ae_file_names, ae = True)

result_path_ecp = work_path + '/Lu/yoon_files/ECP/'
ecp_file_names = ["ip1.d","ip2.d","ip3.d","ip4.d","ip5.d","ip6.d","ip7.d","ip8.d","ip9.d","ip10.d","ip11.d","ip12.d","ip13.d","ip14.d","ip15.d"]
Lu.write_yoon(result_path = result_path_ecp, file_names = ecp_file_names, ae = False)

molpro_path = './'
proc_names = [ "Id1s2", 'Ip1s2','IEf1s1','EAd2s2','IIds2','IIId1','IIIf1','IIIps1','IIIp1','IVp6','VIp4','VIIp3','VIIIp2','IXp1','Xp' ]
S_A =[ "5d", "6p", "5f", "5d", "6s", "5d", "5f", "6s", "6p", "5p", "5p", "5p","5p","5p","5s"]
